...
export const Route = createFileRoute("/auth")({
  head: () => ({ meta: [{ title: "Login Staf — RasaPOS" }, { name: "description", content: "Akses aman untuk Owner dan Kasir RasaPOS." }] }),
  component: AuthPage,
});
